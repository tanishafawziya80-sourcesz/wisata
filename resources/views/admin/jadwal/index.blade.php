...
<div class="container">
            ...
            <tbody>
                ...
                @forelse ($jadwal as $jadwal)
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>
                                {{ $jadwal->paketWisata->nama_paket ?? '-' }}
                            </strong>
                        </td>

                        <td>
                            {{ $jadwal->id_tour_leader }}
                        </td>

                        <td>
                            {{ \Carbon\Carbon::parse($jadwal->tgl_keberangkatan)->format('d M Y') }}
                        </td>

                        <td>
                            {{ \Carbon\Carbon::parse($jadwal->tgl_kepulangan)->format('d M Y') }}
                        </td>
    ...
    ">
        ...
        <a
            href="{{ route('admin.jadwal-tour.edit', $jadwal->id_jadwal) }}"
            style="
                display:inline-block;
                padding:8px 13px;
                border-radius:20px;
        ...
        <form
            action="{{ route('admin.jadwal-tour.destroy', $jadwal->id_jadwal) }}"
            method="POST"
            onsubmit="return confirm('Yakin ingin menghapus jadwal tour ini?')"
